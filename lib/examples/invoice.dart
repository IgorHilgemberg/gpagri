...
Future<Uint8List> generateInvoice(PdfPageFormat format, CustomData data) async {
  ...
  final List<Aplicacao> aplicacoes = await getaplicacoes(codSafra: '1');
  final List<InsumoAplicacao> insumos =
      await getInsumosAplicacao(aplicacao: '1');
  ...
  doc.addPage(pw.MultiPage(
      ...
      header: (pw.Context context) {
        ...
        return pw.Container(
            ...
            child: pw.Text('Relatório de aplicação',
      ...
      build: (pw.Context context) => <pw.Widget>[
            pw.RichText(
              text: pw.TextSpan(
                  ...
                  children: [
                    pw.TextSpan(text: aplicacoes.first.nomePropriedade),
                    pw.TextSpan(
                      text: '=>' + aplicacoes.first.nomeCampo!,
                      // style: pw.TextStyle(
                      //   fontStyle: pw.FontStyle.italic,
                      //   fontWeight: pw.FontWeight.normal,
                      // ),
                    ),
                    pw.TextSpan(text: '=>' + aplicacoes.first.codTalhao!),
                  ]),
            ),
              ...
              children: [
                pw.RichText(
                  text: pw.TextSpan(
                      ...
                      children: [
                        pw.TextSpan(text: aplicacoes.first.codSafra! + ' => '),
                        pw.TextSpan(text: aplicacoes.first.nomePlantio),
                      ]),
                ),
              ],
            ),
              ...
              children: [
                pw.RichText(
                  text: pw.TextSpan(
                      ...
                      children: [
                        const pw.TextSpan(text: 'Aplicação: '),
                        pw.TextSpan(text: aplicacoes.first.name! + ' - '),
                        pw.TextSpan(text: aplicacoes.first.codCultivar),
                      ]),
                ),
              ],
            ),
                ...
                pw.RichText(
                  text: pw.TextSpan(
                      ...
                      children: [
                        pw.TextSpan(
                            text:
                                'Data da aplicação: ' + aplicacoes.first.data!),
                      ]),
                ),
              ],
            ),
              ...
              children: [
                pw.RichText(
                  text: pw.TextSpan(
                      ...
                      children: const [
                        pw.TextSpan(text: 'Resumo da aplicação'),
                      ]),
                ),
              ],
            ),
